...
typedef UARTRSR_t UARTECR_t;

typedef union UARTFR_t {    // 0x018
    uint32_t all;
    struct {
        uint32_t CTS:1;     // 0
        uint32_t DSR:1;     // 1
...
typedef union UARTILPR_t {  // 0x020
    uint32_t all;
    struct {
...
typedef union UARTIBRD_t {  // 0x024
    uint32_t all;
    struct {
        uint32_t BAUD_DIVINT:16;    // 15:0
        uint32_t reserved:16;
    } bits;
} UARTIBRD_t;

typedef union UARTFBRD_t {  // 0x028
    uint32_t all;
    struct {
        uint32_t BAUD_DIVFRAC:6;    // 5:0
        uint32_t reserved:26;
    } bits;
} UARTFBRD_t;

typedef union UARTLCR_H_t { // 0x02C
    uint32_t all;
    struct {
        uint32_t BRK:1;     // 0
        uint32_t PEN:1;     // 1
...
typedef union UARTIFLS_t {  // 0x034
    uint32_t all;
    struct {
...
typedef union UARTIMSC_t {  // 0x038
    uint32_t all;
    struct {
        uint32_t RIMIM:1;   // 0
        uint32_t CTSMIM:1;  // 1
...
typedef union UARTDMACR_t { // 0x048
    uint32_t all;
    struct {
        uint32_t RXDMAE:1;      // 0
        uint32_t TXDMAE:1;      // 1    
